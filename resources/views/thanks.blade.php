        ...
        <main id="maincontent">
            ...
            <nav aria-label="breadcrumb" id="myBreadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Bedankt</li>
                </ol>
            </nav>

            <h2 class="text-secondary mb-5">Bedankt voor de bestelling, deze wordt zo snel mogelijk afgehandeld.</h2>
