                ...
                <div id="carousel_getuigenissen" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <div>
                                <img src="{{asset('images/home/getuige1.jpg')}}" class="d-block float-left pr-3" width="135" height="135" alt="getuige1">
                        ...
                        <div class="carousel-item">
                            <div>
                                <img src="{{asset('images/home/getuige2.jpg')}}" class="d-block float-left pr-3" width="135" height="135" alt="getuige2">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci cupiditate inventore neque pariatur quis quod veniam voluptate! Aperiam enim iusto nam nesciunt voluptas! Atque deleniti maxime nobis quaerat quasi totam.</p>
                            </div>
                        ...
                        <div class="carousel-item">
                            <div>
                                <img src="{{asset('images/home/getuige3.jpg')}}" class="d-block float-left pr-3" width="135" height="135" alt="getuige3">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci cupiditate inventore neque pariatur quis quod veniam voluptate! Aperiam enim iusto nam nesciunt voluptas! Atque deleniti maxime nobis quaerat quasi totam.</p>
                            </div>
